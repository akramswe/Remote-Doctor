                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li @if(strstr($curl,"assign_country"))
                             class="active"
                             @endif>
                            <a href="{{url('assign_country')}}"><i class="fa fa-globe"></i> <span>Assign Country</span></a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-wheelchair"></i> <span>Patients</span></a>
                        </li>
                        <li>
                            <a href="appointment1"><i class="fa fa-calendar"></i> <span>Appointments</span></a>
                        </li>
