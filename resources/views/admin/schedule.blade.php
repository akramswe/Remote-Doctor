            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="addschedule" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Schedule</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table mb-0">
								...
								<tbody>
                                    ...
                                    @endif 
										<td><a href="{{action('ScheduleController@edit', $schedules['id'])}}" class="btn btn-warning"> <i class="fa fa-pencil-square-o"></i> Edit</a></td>   
                                        <td>
                                            <form method="post" class="delete_form" action="{{action('ScheduleController@destroy', $schedules['id'])}}">
      {{csrf_field()}}
