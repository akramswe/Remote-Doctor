...
@extends('admin.layouts.app1')
        <div class="page-wrapper">
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action ="addcoordinate" method = "post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="row">
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <!-- <input class="form-control" name="fname" type="text"> -->
                                         <input  class="form-control" type="text" name='coordinate_id'/>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <!-- <input class="form-control" name="fname" type="text"> -->
                                         <input  class="form-control" type="text" name='coordinate_fname'/>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Last Name</label>
                                        <input class="form-control" name="coordinate_lname" type="text">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="password" type="password" type="password">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                            ...
                            <div class="m-t-20 text-center">
                                <input type = 'submit' class="btn btn-primary submit-btn" value = "Create coordinate"/>
